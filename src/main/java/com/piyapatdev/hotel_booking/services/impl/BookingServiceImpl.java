package com.piyapatdev.hotel_booking.services.impl;
...
import com.piyapatdev.hotel_booking.entities.Room;
...
import com.piyapatdev.hotel_booking.exceptions.InvalidBookingStateAndDateException;
...
import com.piyapatdev.hotel_booking.repositories.RoomRepository;
import com.piyapatdev.hotel_booking.services.BookingCodeGenerator;
import com.piyapatdev.hotel_booking.services.BookingService;
...
public class BookingServiceImpl implements BookingService {
    ...
    public Response createBooking(BookingDTO bookingDTO) {
        ...
        Room room = roomRepository.findById(bookingDTO.getRoomId())
                .orElseThrow(()-> new NotFoundException("Room not found please try again"));


        //validation: Ensure the check-in date is not before today
        if (bookingDTO.getCheckInDate().isBefore(LocalDate.now())){
            throw new InvalidBookingStateAndDateException("check-in date is not correct please try again");
        }

        //validation: Ensure the check-out date is not before check in date
        if (bookingDTO.getCheckOutDate().isBefore(bookingDTO.getCheckInDate())){
            throw new InvalidBookingStateAndDateException("check-out date is not correct please try again");
        }
        ...
        NotificationDTO notificationDTO = NotificationDTO.builder()
                ...
                .body(String.format("Your booking has been successfully created. Please proceed with your payment using the payment link below " +
                        "\n%s", paymentUrl))
    ...
    //calculate total price of room based on days that customers stay in our hotel
