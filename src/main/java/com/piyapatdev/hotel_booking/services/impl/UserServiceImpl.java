...
import com.piyapatdev.hotel_booking.dtos.*;
...
import com.piyapatdev.hotel_booking.exceptions.InvalidCredentialException;
...
import com.piyapatdev.hotel_booking.security.JwtUtils;
...
public class UserServiceImpl implements UserService {
    ...
    public Response loginUser(LoginRequest loginRequest) {
        User user = userRepository.findByEmail(loginRequest.getEmail())
                .orElseThrow(()-> new NotFoundException("Email not found please try again"));

        if (!passwordEncoder.matches(loginRequest.getPassword(), user.getPassword())) {
            throw new InvalidCredentialException("Password is incorrect please try again");
        }
    ...
    public User getCurrentLoggedInUser() {
        ...
        return userRepository.findByEmail(email)
                .orElseThrow(()-> new NotFoundException("User not found please try again"));
    }
